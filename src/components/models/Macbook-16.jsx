...
Files: macbook-16.glb [639.28KB] > C:\Users\godsp\all\apple-web\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
function useScreenTexture() {
  return useMemo(() => {
    const texture = new TextureLoader().load('/screen.png')
